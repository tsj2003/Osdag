...
class Plateui(Member):
    

    def __init__(self):
        print('in constructor')
        super(Plateui, self).__init__()
    ...
    def tab_list(self):
        ...
        t2 = ("Additional Sectional Data", TYPE_TAB_2, self.optimization_tab_flexure_design)
        tabs.append(t2)

        t5 = ("Stiffener", TYPE_TAB_2, self.design_values)
        tabs.append(t5)
    ...
    def input_values(self):
        ...
        self.module = KEY_DISP_PLATE_GIRDER
        options_list = []

        t1 = (None, DISP_TITLE_PG, TYPE_TITLE, None, True, 'No Validator')
        options_list.append(t1)

        t1 = (KEY_MODULE, KEY_DISP_PLATE_GIRDER, TYPE_MODULE, None, True, "No Validator")
        options_list.append(t1)
        
        t4 = (KEY_MATERIAL, KEY_DISP_MATERIAL, TYPE_COMBOBOX, VALUES_MATERIAL, True, 'No Validator')
        options_list.append(t4)
        
        t2 = (KEY_LENGTH, KEY_DISP_LENGTH_TOP_BEAM_PG, TYPE_TEXTBOX, None, True, 'Int Validator')
        options_list.append(t2)
        
        
        
        t4 = (KEY_SEC_PROFILE, KEY_DISP_TOP_FLANGE_THICKNESS_PG, TYPE_COMBOBOX, ['All','Customized'], True, 'No Validator') #'Beam and Column'
        options_list.append(t4)
        
        t2 = (KEY_LENGTH, KEY_DISP_BOTTOM_FLANGE_PG, TYPE_TEXTBOX, None, True, 'Int Validator')
        options_list.append(t2)

        t4 = (KEY_SECSIZE, KEY_DISP_BOTTOM_FLANGE_THICKNESS_PG, TYPE_COMBOBOX_CUSTOMIZED, ['All','Customized'], True, 'No Validator')
        options_list.append(t4)

        # t4 = (KEY_MATERIAL, KEY_DISP_MATERIAL, TYPE_COMBOBOX, VALUES_MATERIAL, True, 'No Validator')
        # options_list.append(t4)
        
        t4 = (KEY_SECSIZE, KEY_DISP_THICKNESS_PG, TYPE_COMBOBOX_CUSTOMIZED, ['All','Customized'], True, 'No Validator')
        options_list.append(t4)
        
        t2 = (KEY_LENGTH, KEY_DISP_OVERALL_DEPTH_PG, TYPE_TEXTBOX, None, True, 'Int Validator')
        options_list.append(t2)
        
        t2 = (KEY_LENGTH, KEY_DISP_LENGTH_BEAM_PG , TYPE_TEXTBOX, None, True, 'Int Validator')
        options_list.append(t2)

        t1 = (None, KEY_SECTION_DATA_PG, TYPE_TITLE, None, True, 'No Validator')
        options_list.append(t1)
        ...
        t4 = (KEY_SECSIZE, KEY_DISP_SECSIZE_pg, TYPE_COMBOBOX_CUSTOMIZED, ['Highway Bridge', 'Railway Bridge', 'Industrial Structure'], True, 'No Validator')
        options_list.append(t4)
        
        t4 = (KEY_SECSIZE, KEY_DISP_SUP_PG, TYPE_COMBOBOX_CUSTOMIZED, ['Thin Web with ITS',   'Thick Web without ITS'], True, 'No Validator')
        options_list.append(t4)
        ...
        t7 = (None, KEY_Loading_DATA_PG, TYPE_TITLE, None, True, 'No Validator')
        options_list.append(t7)

        t8 = (KEY_MOMENT, KEY_DISP_BOTTOM_FLANGE_FACTORED_PG, TYPE_TEXTBOX, None, True, 'No Validator')
        options_list.append(t8)

        t8 = (KEY_SHEAR, KEY_DISP_WEB_FLANGE_THICKNESS_2_PG, TYPE_TEXTBOX, None, True, 'No Validator')
        options_list.append(t8)
    ...
    def output_values(self, flag):
        ...
        t1 = (None, DISP_TITLE_STRUT_SECTION_PG, TYPE_TITLE, None, True)

        out_list.append(t1)

        t1 = (KEY_TITLE_OPTIMUM_DESIGNATION, KEY_DISP_TITLE_OPTIMUM_DESIGNATION_PG, TYPE_TEXTBOX,
              self.result_designation if flag else '', True)
        out_list.append(t1)

        t1 = (
        KEY_OPTIMUM_UR_COMPRESSION, KEY_DISP_OPTIMUM_DS_COMPRESSION_PG, TYPE_TEXTBOX, round(self.result_UR,3) if flag else '', True)
        out_list.append(t1)

        t1 = (KEY_OPTIMUM_SC, KEY_DISP_OPTIMUM_PG, TYPE_TEXTBOX, self.result_section_class if flag else '', True)
        out_list.append(t1)


        t2 = (KEY_betab_constatnt,KEY_DISP_FLANG_PG, TYPE_TEXTBOX,
              round(self.result_betab,2) if flag else '', True)
        out_list.append(t2)


        t2 = (
        KEY_EFF_SEC_AREA, KEY_DISP_THICKNESS_PG, TYPE_TEXTBOX, self.result_effective_area if flag else '',
        True)
        out_list.append(t2)

        

        t1 = (None,KEY_DESIGN_COMPRESSION_PG , TYPE_TITLE, None, True)
        out_list.append(t1)

        t1 = (KEY_SHEAR_STRENGTH, KEY_DISP_DESIGN_STRENGTH_SHEAR_PG, TYPE_TEXTBOX,
              self.result_shear  if flag else
              '', True)
        out_list.append(t1)
        #
        t1 = (KEY_MOMENT_STRENGTH, KEY_DISP_DESIGN_STRENGTH_MOMENT_PG, TYPE_TEXTBOX,
        ...
        t1 = (None, KEY_DESIGN_STIFFER_PG , TYPE_TITLE, None, True)
        out_list.append(t1)

        t1 = (KEY_SHEAR_STRENGTH, KEY_DISP_DESIGN_STIFFER_PG, TYPE_TEXTBOX,
              self.result_shear  if flag else
              '', True)
        out_list.append(t1)
        #
        t1 = (KEY_MOMENT_STRENGTH, KEY_DISP_DESIGN_STIFFER_SPACE_PG, TYPE_TEXTBOX,
              self.result_bending  if flag else
              '', True)
        out_list.append(t1)
